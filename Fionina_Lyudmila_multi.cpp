...
void BeginScreen ()
    ...
    SubtitlesDraw  ("В одном лесу...");
    txSleep        (500);

    ForestDraw     (200);

    SubtitlesDraw  ("В одном лесу...  стоит теремок...");
    txSleep        (500);

    HomeDraw       (800, 350, 150, 160, 90, 1);
    txSleep        (500);

    SubtitlesDraw  ("Вокруг теремка на полянке красота...");
    txSleep        (500);
    GladeDraw      (  0);
    txSleep        (500);

    SubtitlesDraw  ("Пчёлки летают, медок собирают...");
    txSleep        (500);
